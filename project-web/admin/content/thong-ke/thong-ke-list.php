            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="../../../tai-khoan/dang-xuat.php"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div id="page-wrapper">
		    <div class="header"> 
                <div class="page-header">
                    ...
                    <p>Dưới đây là những số liệu thống kê hàng hóa của BULL STORE hiện tại có trong kho: </p>
