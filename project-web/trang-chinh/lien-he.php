...
<head>
    ...
    <title>Liên hệ</title>
    <style>
        .float-right { padding: 0;border: 0; font-size: 100%;}
        .float-right .contact { list-style: none;}
        .float-right .contact ul { display: -webkit-box; display: -ms-flexbox; display: flex; }
        .float-right .contact ul .logo-contact { margin-top: 10px; margin-left: 15px; }
        .float-right .contact ul .logo-contact #icon-c { width: 35px; height: 35px; }
    </style>
</head>
...
<body>
                ...
                <div class="lienhe">
                    ...
                    <table class="tus">
                        <tr>
                            ...
                            <td>999 Đường vành đai ĐHQG - Đông Hòa - Dĩ An - Bình Dương</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>chequanghuybtt@gmail.com</td>
                        </tr>
                        <tr>
                            <td><img src="../../bigshoes/css/lien-he/img/d.png" alt=""></td>
                            <td>https://www.facebook.com/huycheeeeee/</td>
                        </tr>
                    </table>
    ...
    <div class="container-fluid" style="margin-top: 40px;">
        <div class="row">
            <div class="col-md-12">
                <div class="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15672.573803027182!2d106.81063151276008!3d10.876692053041534!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d958707f8685%3A0xd577177b5198597f!2zxJDhuqFpIGjhu41jIELDoWNoIEtob2EgVFAuSENNIGPGoSBz4bufIDI!5e0!3m2!1svi!2s!4v1654575044723!5m2!1svi!2s"
