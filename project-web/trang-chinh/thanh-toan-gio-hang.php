...
<body>
    ...
    <?php
        require_once ('../../project-web/admin/dao/khach-hang.php');
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            <div class="col-sm-7">
                <form action="" method="post">
                    ...
                    <br>
                    <table class="table table-borderless" boder = "0">
                    ...
                    <div class="col-sm-5">
                        ...
                        <table class="table" style = "border:3px solid #c30005;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><b>Giao hàng</b></td>
                                    <td style = "text-align:right;">Giao hàng miễn phí dưới 5km.</td>
                                </tr>
                                <tr>
                                    <td><b>TỔNG</b></td>
                                    <td style = "text-align:right;"><b><?=number_format($total)?> VNĐ</b></td>
        ...
        <?php
            require_once ('../../project-web/admin/dao/hoa-don.php');
            extract($_REQUEST);
        ...
        <?php
            ...
            if(array_key_exists('dathangonline',$_REQUEST)){
                try {
                    ...
                    header("Location: http://localhost/project-web/vnpay_php/index.php?order_id=" .$ma_hd. "&total=".$total);
                    exit();
                } 
                catch (PDOException $e) {
                    echo $e->getMessage();
