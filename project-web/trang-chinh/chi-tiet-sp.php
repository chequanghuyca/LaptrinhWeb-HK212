...
<body>
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            <?php
                require_once ('../../project-web/admin/dao/hang-hoa.php');
                    extract($_REQUEST);
            ...
            <div class="col-md-4" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../project-web/css/admin/images/products/<?=$hinh?>" alt="" style="width:100%;">
                </div>
            </div>
            <div class="col-md-5">
                <div class="thongtinsp">
                    <ul>
                        <li><h5 style="font-size: 30px;"><?=$ten_hh?></h5></li>
                        ...
                        <li class="gu" style="margin-top: 20px;"> <img src="../../project-web/css/chi-tiet-sp/img/ttt.png" alt=""> </li>
                        ...
                        <li class="soluong1" style="margin-top: 27px;">
                            ...
                            <?php
                                if(!isset($_SESSION['user'])){
                            ?>
                            <a href="../../project-web/tai-khoan/dang-nhap.php"><button style="margin-top:-5px;" class="btn btn-dark">ĐĂNG NHẬP ĐỂ MUA HÀNG</button></a>
                                <?php }else{ ?>
            ...
            <div class="col-md-3">
                <div class="thanhtoan">
                    <div class="row">
                        ...
                        <ul>
                            <li> <img src="../../project-web/css/chi-tiet-sp/img/l2.png" alt=""> </li>
                            <li> <img src="../../project-web/css/chi-tiet-sp/img/l1.png" alt=""> </li><br>
                            <li> <img src="../../project-web/css/chi-tiet-sp/img/l4.png" alt=""> </li>
                            <li> <img src="../../project-web/css/chi-tiet-sp/img/l3.png" alt=""> </li>
                        </ul>
                   </div>
                   <div class="row">
                        <a href="danh-sach-sp.php"><img src="../../project-web/css/chi-tiet-sp/img/SALES.png" alt="" style="width:100%"></a>  
                   </div>
                </div>
            </div>
        </div>
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    <div class="item">
                        <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>">
                            <img style="width: 200px" src="../../project-web/css/admin/images/products/<?=$hinh?>" alt="ds"><span class='cung-loai'><?=$ten_loai?></span>
                        </a>
                    </div>
                    <?php } ?>
                </div>
        ...
        <div class="row">
            <div class="container" style="margin-top: 50px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="fo">
                            <img src="../../project-web/css/trang-chu/img/logo.png " alt="logo BULL STORE" style ="width:60px;">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="fo">
                ...
                <div class="row" style="margin-top: 0px;">
                    <div class="col-md-3">
                        <div class="fo">
                            <ul>
                                <li>
                                    <p> Nhiệm vụ của chúng tôi là mang đến những sản phẩm chất lượng với giá cả tốt nhất cho khách hàng. 
                                        Được hỗ trợ khách hàng là niềm vinh dự của chúng tôi. <br><br>Xin cám ơn!                                    
                                </p>
                                </li>
