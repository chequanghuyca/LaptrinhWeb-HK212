                    ...
                    <div class="row" style="margin-top: 35px;margin-left: 0px;">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>&ma_loai=<?=$ma_loai?>">
                                        <img style="width:80px;" src="../../project-web/css/admin/images/products/<?=$hinh?>" alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-8">
                                        <?=$ten_hh?><br><br><b><?=number_format($don_gia-($don_gia*$giam_gia/100))?> VNĐ</b>
                                    </div>
                                </div>
                            </li>
                            <?php } ?>
            ...
            ?>
                <div class="sanpham">
                    <a href="chi-tiet-sp.php?ma_hh=<?=$ma_hh?>">
                        <img src="../../project-web/css/admin/images/products/<?=$hinh?>" alt="">
                    </a>
                    <div class="text">
                        <div class="price">
                            <?=$don_gia?> VNĐ
