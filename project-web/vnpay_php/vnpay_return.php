...
<html lang="en">
    <head>
        ...
        <link href="/project-web/vnpay_php/assets/bootstrap.min.css" rel="stylesheet"/>
        <link href="/project-web/vnpay_php/assets/jumbotron-narrow.css" rel="stylesheet">         
        <script src="/project-web/vnpay_php/assets/jquery-1.11.3.min.js"></script>
    </head>
    <body>
        <?php
        require_once("../../project-web/admin/dao/pdo.php");
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                        ...
                        <?php
                            if ($secureHash == $vnp_SecureHash) {
                                if ($_GET['vnp_ResponseCode'] == '00') {
                                    ...
                                    $conn = new mysqli("localhost","root","","project-web");
                                    $taikhoan = '';
                    ...
                    <br>
                    <a href="http://localhost/project-web/trang-chinh/">
                        <button>Về trang chính</button>
                    </a>
                    <a href="http://localhost/project-web/trang-chinh/danh-sach-sp.php">
